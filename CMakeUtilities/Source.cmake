...
# 특정 경로에 포함된 특정 확장자(들)을 가진 파일들의 상대 경로를 반환하는 매크로
...
macro(SCAF_UTILITY_GET_FILES_IN_DIRECTORY
    IN_TARGET_DIRECTORY
    IN_FILE_EXTENSIONS
    ...
    foreach(FILE_EXTENSION ${IN_FILE_EXTENSIONS})
        ...
        foreach(FILE ${FILES})
            ...
            if(NOT IS_DIRECTORY ${RELATIVE_FILE_PATH})
                set(FILE_LIST ${FILE_LIST} ${RELATIVE_FILE_PATH}) # Append list
            endif()
        endforeach()
    endforeach()

    set(${OUT_RESULT_RELATIVE_FILE_PATH_LIST} ${FILE_LIST})
endmacro()

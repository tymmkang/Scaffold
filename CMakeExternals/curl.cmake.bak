...
function(SCAF_EM_FUNC_ADD_CURL 
    ...
    if (NOT TARGET ${VAR_EXTERNAL_NAME})
        ...
        ExternalProject_Add(${VAR_EXTERNAL_NAME} 
            ...
            INSTALL_DIR ${SCAF_CONFIG_EXTERNAL_MODULE_PREFIX_DIR}/${VAR_EXTERNAL_NAME}
        ...
        set_target_properties(${VAR_EXTERNAL_NAME} PROPERTIES FOLDER ${SCAF_CONFIG_EXTERNAL_MODULE_RELATIVE_DIR})

...
# Git repository : https://github.com/KhronosGroup/OpenGL-Registry
# Header-Only

function(SCAF_EM_FUNC_ADD_OPENGL_REGISTRY_API
    TARGET_MODULE
    API)

    set(VAR_EXTERNAL_NAME           "opengl-registry")
    set(VAR_EXTERNAL_GIT_REPO_URL   "https://github.com/KhronosGroup/OpenGL-Registry")
